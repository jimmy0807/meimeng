...
class ChufangMubanRequest: ICRequest
{
    ...
    override func willStart() -> Bool
    {
        ...
        self.sendRpcXmlCommand("/xmlrpc/2/ds_api", method: "prescription_template_list", params: [params])
        return true
    }
    ...
    override func didFinishOnMainThread()
    {
        ...
        self.finished?(dict)
        NotificationCenter.default.post(name: NSNotification.Name(rawValue:"ChufangMubanResponse"), object: nil, userInfo:resultDict)
    }
}
