...
class WenZhenKaijianchaRequest: ICRequest
{
    ...
    override func willStart() -> Bool
    {
        ...
        self.sendRpcXmlCommand("/xmlrpc/2/ds_api", method: "wenzhen_new_check", params: [params])
        return true
    }
    ...
    override func didFinishOnMainThread()
    {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue:"WenZhenKaijianchaResponse"), object: nil, userInfo:resultDict)
