//
//  WenZhenKaichufangRequest.swift
//  meim
//
...
class WenZhenKaichufangRequest: ICRequest
{
    ...
    override func willStart() -> Bool
    {
        ...
        self.sendRpcXmlCommand("/xmlrpc/2/ds_api", method: "wenzhen_new_prescription", params: [params])
        return true
    }
    ...
    override func didFinishOnMainThread()
    {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue:"WenZhenKaichufangResponse"), object: nil, userInfo:resultDict)
