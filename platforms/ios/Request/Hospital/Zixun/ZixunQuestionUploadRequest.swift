//
//  ZixunQuestionUploadRequest.swift
//  meim
//
...
class ZixunQuestionUploadRequest: ICRequest
{
    ...
    override func willStart() -> Bool
    {
        ...
        self.sendRpcXmlCommand("/xmlrpc/2/ds_api", method: "save_evaluation_record", params: [params])
