//
//  HZixunStartRequest.swift
//  meim
//
//  Created by jimmy on 2017/6/19.
//
//

import UIKit

class HZixunStartRequest: ICRequest
{
    ...
    override func willStart() -> Bool
    {
        ...
        self.sendRpcXmlCommand("/xmlrpc/2/ds_api", method: "zhixun_start", params: [params])
