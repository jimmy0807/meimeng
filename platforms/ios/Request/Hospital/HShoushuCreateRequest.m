...
@interface HShoushuCreateRequest ()
...
@implementation HShoushuCreateRequest

- (id)initWithShoushuID:(NSNumber *)shoushuID params:(NSDictionary *)params isEdit:(BOOL)isEdit
{
    self = [super init];
    if (self != nil)
    {
        self.params = params;
        if ( [shoushuID integerValue] > 0 )
        {
...
- (void)didFinishOnMainThread
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:kHShoushuCreateResponse object:self userInfo:params];
}
