...
class FetchCheckDetailRequest: ICRequest
{
    ...
    override func willStart() -> Bool
    {
        ...
        self.sendRpcXmlCommand("/xmlrpc/2/ds_api", method: "pos_check_detail", params: [params])
    ...
    override func didFinishOnMainThread()
    {
        ...
        self.finished?(dict)
        NotificationCenter.default.post(name: NSNotification.Name(rawValue:"CheckDetailFetchResponse"), object: nil, userInfo:resultDict)
    }
}
