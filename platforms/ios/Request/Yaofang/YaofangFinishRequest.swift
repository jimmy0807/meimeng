...
class YaofangFinishRequest: ICRequest
{
    ...
    override func willStart() -> Bool
    {
        ...
        self.sendRpcXmlCommand("/xmlrpc/2/ds_api", method: "pos_prescription_update", params: [params])
    ...
    override func didFinishOnMainThread()
    {
        ...
        self.finished?(dict)
        NotificationCenter.default.post(name: NSNotification.Name(rawValue:"YaofangFinishResponse"), object: nil, userInfo:resultDict)
    }
}
