...
class BingfangCheckOutRequest: ICRequest
{
    ...
    override func willStart() -> Bool
    {
        ...
        self.sendRpcXmlCommand("/xmlrpc/2/ds_api", method: "hospitalized_check_out", params: [params])
        return true
    }
    ...
    override func didFinishOnMainThread()
    {
        ...
        self.finished?(dict)
        NotificationCenter.default.post(name: NSNotification.Name(rawValue:"BingfangCheckOutResponse"), object: nil, userInfo:resultDict)
    }
}
