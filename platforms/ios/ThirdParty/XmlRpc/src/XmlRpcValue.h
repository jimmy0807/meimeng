...
namespace XmlRpc {
  ...
  public:
    ...
    typedef std::map<std::string, XmlRpcValue> ValueStruct;
      ...
      struct tm* &asDateTime();
      const struct tm* &asDateTime() const;
    
      BinaryData &asBinaryData();
      const BinaryData &asBinaryData() const;
      
      ValueArray &asValueArray();
      const ValueArray& asValueArray() const;
      
      ValueStruct &asValueStruct();
      const ValueStruct& asValueStruct() const;
