...
namespace XmlRpc {
  ...
  static const char STRUCT_ETAG[]   = "</struct>";
    ...
    int &XmlRpcValue::asInt()
    {
        return _value.asInt;
    }
    
    double &XmlRpcValue::asDouble()
    {
        return _value.asDouble;
    }
    
    bool &XmlRpcValue::asBoolean()
    {
        return _value.asBool;
    }
    
    std::string &XmlRpcValue::asString()
    {
        return *_value.asString;
    }
    
    struct tm* &XmlRpcValue::asDateTime()
    {
        return _value.asTime;
    }
    
    XmlRpcValue::BinaryData &XmlRpcValue::asBinaryData()
    {
        return *_value.asBinary;
    }
    
    XmlRpcValue::ValueArray& XmlRpcValue::asValueArray()
    {
        return *_value.asArray;
    }

    XmlRpcValue::ValueStruct& XmlRpcValue::asValueStruct()
    {
