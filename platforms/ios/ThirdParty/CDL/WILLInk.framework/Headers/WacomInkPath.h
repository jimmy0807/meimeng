...
/**
 ...
 @return Instance of type WCMFloatVectorPointer pointing to the created preliminary path.
 @discussion <b>The returned object is only valid while the instance is not modified and is alive. You should not store it. If you need to store the data, create a new WCMFloatVector initialized with the data of the result</b>
 */
...
/**
 @since 1.7
 @abstract The method calculates a path part (a set of control points) without updating the path builder state. This path part will behave like the path is being finished at the passed location. The returned path part can be modified by clients (for example, it can be smoothed). After that the part should be passed to the [WCMAbstractPathBuilder finishPreliminaryPath:] method.
 @param location Specify a point to which to create a preliminary path.
 @return Instance of type WCMFloatVectorPointer pointing to the created preliminary path.
 @discussion <b>The returned object is only valid while the instance is not modified and is alive. You should not store it. If you need to store the data, create a new WCMFloatVector initialized with the data of the result</b>
 */
-(WCMFloatVectorPointer*) createPreliminaryPathToLocation:(CGPoint)location;
