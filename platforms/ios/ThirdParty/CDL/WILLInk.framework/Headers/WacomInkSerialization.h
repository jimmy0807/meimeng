...
/**
 * The WCMInkLegacyDecoder class implements iterator-based interface for decoding compressed ink data, produced by the WCMInkEncoder from WILL version 1.2 and earlier.
 * @since 1.8.5
 */
WACOMINK_PUBLIC
@interface WCMInkLegacyDecoder : NSObject

/**
 @abstract Initialized the WCMInkLegacyDecoder instance with data.
 @param data NSData produced by the WCMInkEncoder.
 @since 1.8.5
 */
-(instancetype) initWithData:(NSData*)data;
...
/**
 @abstract Decodes a stoke data produced by the WCMInkEncoder from WILL version 1.2 and earlier.
 @param points Upon return will contain a WCMFloatVector containing the control points of the stroke.
 @param stride Upon return will contain the stride of the stroke.
 @param width Upon return will contain the width of the stroke.
 @param color Upon return will contain the color of the stroke.
 @param ts Upon return will contain the starting value for the Catmull-Rom spline parameter.
 @param tf Upon return will contain the final value for the Catmull-Rom spline parameter.
 @return Whether or not the decoding process was successful.
 @since 1.8.5
 */
-(bool) decodePathToPoints:(WCMFloatVector**)points andStride:(unsigned int*)stride
                  andWidth:(float*)width andColor:(UIColor**)color andTs:(float*)ts andTf:(float*)tf;
@end
