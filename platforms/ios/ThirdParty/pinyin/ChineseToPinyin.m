...
+ (NSString *)pinyinFirstLetterString:(NSString *)string
{
    ...
    {
        char letter = [ChineseToPinyin sortSectionTitle:[string substringWithRange:NSMakeRange(i, 1)]];
        [pinYin appendFormat:[NSString stringWithFormat:@"%c",letter]];
    }
...
+ (BOOL)isFirstLetterValidate:(NSString *)nameLetter
{
    ...
    return [predicate evaluateWithObject:nameLetter];
}
