//
//  RecommedDetailPhoneNumberView.m
//  meim
//
...
@interface RecommedDetailPhoneNumberView ()

@end

@implementation RecommedDetailPhoneNumberView
...
- (IBAction)okButtonPressed:(id)sender {
    ...
    {
        self.textFieldPhoneBlock(self.phoneNumberTextField.text);
        //赋值电话 给上个视图
        [self.view removeFromSuperview];
    } else
    {
        CBMessageView *message = [[CBMessageView alloc]initWithTitle:@"手机号码格式错误" afterTimeHide:0.75];
        [message showInView:mainWindow];
