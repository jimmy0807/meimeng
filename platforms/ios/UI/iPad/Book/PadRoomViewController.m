...
@interface PadRoomViewController ()<UITableViewDataSource,UITableViewDelegate>
@property(nonatomic, strong) NSArray *itemArray;
@end

@implementation PadRoomViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.navigationController.navigationBarHidden = true;
    self.itemArray = [[BSCoreDataManager currentManager] fetchAllRestaurantTable];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CDRestaurantTable *table = [self.itemArray objectAtIndex:indexPath.row];
...
{
    if ([self.delegate respondsToSelector:@selector(didSelectedRoom:)]) {
        CDRestaurantTable *table = [self.itemArray objectAtIndex:indexPath.row];
        [self.delegate didSelectedRoom:table];
    }
