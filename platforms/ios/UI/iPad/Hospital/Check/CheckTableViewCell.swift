...
class CheckTableViewCell: UITableViewCell {
    ...
    public func initCell()
    {
        ...
        print(member)
        let nameLabel = UILabel(frame: CGRect(x: 205, y: 20, width: 400, height: 20))
        ...
        prescriptionLabel.text = "\(member.object(forKey: "check_state_name") ?? "")"
