//
//  EMenuCollectionViewHorizontalLayout.m
//  meim
//
...
@interface EMenuCollectionViewHorizontalLayout () <UICollectionViewDelegateFlowLayout>
@property (strong, nonatomic) NSMutableArray *allAttributes;
@end

@implementation EMenuCollectionViewHorizontalLayout
