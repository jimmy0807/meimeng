//
//  BingFangRightRoomCollectionViewCell.swift
//  meim
//
...
class BingFangRightRoomCollectionViewCell: UICollectionViewCell
{
...
//                }
                if let name = room.member_name, name.characters.count > 1
                {
                    self.bgImageView.image = #imageLiteral(resourceName: "fenzhen_room_green.png")
                }
                else
