...
class BingFangYuyueView: UIView, UITableViewDataSource, UITableViewDelegate
{
    ...
    {
        self.itemList = BSCoreDataManager.current().fetchDaodianBingfangBook2(searchText)
    ...
    {
        //let cell = BingFangYuyueTableViewCell(style: .default, reuseIdentifier: "BingFangYuyueTableViewCell")//tableView.dequeueReusableCell(withIdentifier: "BingFangYuyueTableViewCell") as! BingFangYuyueTableViewCell
        let cell = tableView.dequeueReusableCell(withIdentifier: "BingFangYuyueTableViewCell") as! BingFangYuyueTableViewCell
        print("\(self.itemList)")
