//
//  HHuifangCreateRightPhotoViewController.m
//  meim
//
...
@interface HHuifangCreateRightPhotoViewController ()
@property(nonatomic, weak)IBOutlet UICollectionView* collectionView;
@end

@implementation HHuifangCreateRightPhotoViewController
...
{
    if ([notification.name isEqualToString:kBSFetchYimeiOperateActivityResponse])
    {
...
{
    return self.visit.photos.count;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CDYimeiImage* yimeiImage = self.visit.photos[indexPath.row];
