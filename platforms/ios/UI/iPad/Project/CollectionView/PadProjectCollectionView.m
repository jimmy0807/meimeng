...
@interface PadProjectCollectionView ()
...
@implementation PadProjectCollectionView
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
    ...
    {
        shouldBegin = self.isProjectCanMove;
        if (self.isProjectCanMove)
        {
...
- (void)resetMovingItem
{
    ...
    PadProjectCollectionCell *cell = (PadProjectCollectionCell *)[self cellForItemAtIndexPath:indexPath];
    cell.alpha = 1.0;
}
...
{
    [self stopAutoScrolling];
    PadProjectCollectionCell *cell = (PadProjectCollectionCell *)[self cellForItemAtIndexPath:self.movingIndexPath];
