//
//  YimeiYaopinSelectViewController.m
//  meim
//
...
@interface YimeiYaopinSelectViewController ()<YimeiYaopinSelectViewControllerDelegate, UISearchBarDelegate>
...
@implementation YimeiYaopinSelectViewController
...
- (void)didConfirmButtonClick:(id)sender
{
    ...
    if ( self.orignalProjectArray )
    {
        [self.delegate didYimeiYaopinSelectViewControllerConfirmButtonPressed:self.posOperate.products.array];
        [self.maskView.navi popViewControllerAnimated:YES];
    }
    else
    {
