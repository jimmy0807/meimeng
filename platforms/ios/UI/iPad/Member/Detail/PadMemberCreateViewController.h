//
//  PadMemberCreateViewController.h
//  Boss
//
...
@interface PadMemberCreateViewController : ICCommonViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate, BNActionSheetDelegate, UITextFieldDelegate>
