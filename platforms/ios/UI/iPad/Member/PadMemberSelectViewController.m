//
//  PadMemberSelectViewController.m
//  Boss
//
...
@interface PadMemberSelectViewController ()
...
@implementation PadMemberSelectViewController

- (id)initWithViewType:(kPadMemberAndCardViewType)viewType
{
    self = [super initWithNibName:@"PadMemberSelectViewController" bundle:nil];
    if (self)
    {
...
- (void)initView
{
    ...
    [self.memberSelectedButton setTitle:@"会员" forState:UIControlStateNormal];
