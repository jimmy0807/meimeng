...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    RotateNavigationController* vc = [[RotateNavigationController alloc] initWithRootViewController:self.viewController];
    [vc.navigationBar setCustomizedNaviBar:true];
